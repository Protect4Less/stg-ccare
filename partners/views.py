...
def upload_create_policy(request):
    ...
    if excel_file is not None and partner_code is not None:
        ...
        for row in worksheet.iter_rows():
            ...
            if row_number != 1 and partner_code in ['1026','1030','1031', '1025', '1014', '1038','1033','1041','1036','1044','1035','1026','1046', '1051','1049','1052','1040','1053','1064','1054'] and email_value != 'None':
